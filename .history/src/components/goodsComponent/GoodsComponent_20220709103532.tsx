...
import GoodsComponentItemCopy from '../goodsComponentItem copy/GoodsComponentItem';
            ...
            <div className='container'>
                <div className='goodsComponent'>
                    <ul className='goodsComponent-list'>
                        {goods.slice(0, visible).map((good) => <GoodsComponentItemCopy good={good} key={good.id} />)}
                    </ul>
