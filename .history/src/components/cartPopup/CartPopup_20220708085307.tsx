...
const CartPopup: React.FC = () => {
    return (
        <div className='cartPopup'>
            <h3 className='cartPopup__title'>Оформить заказ</h3>
            <p className='cartPopup__desc'>Введите свои контактные данные, и наш менеджер свяжется с Вами в течении 1 часа</p>
